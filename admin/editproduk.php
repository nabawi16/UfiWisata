                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="ubahproduk.php?id=<?php echo $p['idproduk'] ?>"> Edit</a></td> 
                                                <td> <a href="produk.php"> Del</a></td>
                                                <!-- <td><button data-toggle="modal" data-target="#edit<?=$p;?>" class="btn btn-warning">Edit</button> <button data-toggle="modal" data-target="#del<?=$p;?>" class="btn btn-danger">Del</button></td> -->
                                            </tr>

                                                <!-- The Modal -->
                                                <div class="modal fade" id="edit<?=$p;?>">
                                                    <div class="modal-dialog">
                                                    <div class="modal-content">
                                                    <form method="post">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                        <h4 class="modal-title">Edit Barang <?php echo $p['namaproduk']?> - <?php echo $p['namakategori']?> - <?php echo $p['deskripsi']?></h4>
                                                        ...
                                                        <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $p['namaproduk'] ?>">

                                                        <label for="jenis">Jenis</label>
                                                        <input type="text" id="jenis" name="jenis" class="form-control" value="<?php echo $p['namkategori'] ?>">
                                                        ...
                                                        <input type="hidden" name="idbrg" value="<?=$p;?>">
