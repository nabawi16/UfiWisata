...
<head>
    ...
    <title>Kelola Metode Pembayaran - Travel Agent</title>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td>
                                                    <button class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idpr;?>" class="btn btn-info col-md-2">Delete</button>
                                                    </td>
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <form action="pembayaran.php" method="post">
                                                                ...
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Hapus Barang <?php echo $p['no']?></h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>
                                                                
                                                                <!-- Modal body -->
                                                                <div class="modal-body">
                                                                    Apakah Anda yakin ingin menghapus metode pembayaran ini dari daftar pembayaran?
                                                                    <input type="hidden" name="idkategori" value="<?=$idpr;?>">
                                                                </div>
                                                                
                                                                <!-- Modal footer -->
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                                    <button type="submit" class="btn btn-success" name="hapusmetodepr">Hapus</button>
                                                                </div>
                                                                </form>
                                                            </div>
                                                        </div>
                                                ...
                                                //menghapus barang
                                                if (isset($_POST["hapusmetodepr"])) {
                                                
                                                    $hapuspr = mysqli_query($conn,"delete from pembayaran where no='$idpr'");
                                                    if ($hapuspr) {
                                                        echo "<br><meta http-equiv='refresh' content='1; URL=pembayaran.php'> Deleting";
                                                    }else {
                                                        echo "<br><meta http-equiv='refresh' content='1; URL=pembayaran.php'> Failed";        }
                                                    }
