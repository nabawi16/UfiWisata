...
<head>
    ...
    <title>Admin Panel - UFI Wisata</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li><a href="../"><span>Kembali ke Aplikasi</span></a></li>
							<li>
                                <a href="manageorder.php"><i class="ti-dashboard"></i><span>Kelola Pesanan</span></a>
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Kelola Aplikasi
                                    </span></a>
                                <ul class="collapse">
