...
<head>
    ...
    <title>Kelola Pesanan - UFI Wisata</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<a href="datapesanan.php" target="_blank" class="btn btn-info">Export Data Sementara</a>
                                    
                                    <a href="cetakpesanan.php" target="_blank" class="btn btn-info">Export Semua Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
