...
<head>
    ...
    <title>Kelola Produk - UFI Wisata</title>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="produk.php">Paket Wisata</a></li>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-warning" data-toggle="modal" data-target="#updateproduk<?php echo $idproduk ?>" class="btn btn-info col-md-2">Update</button>
                                                    
                                                    <button class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idproduk;?>" class="btn btn-info col-md-2">Delete</button>
                                            ...
                                            <!-- modal edit -->
                                            <div id="updateproduk<?php echo $idproduk ?>" class="modal fade">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="produk.php" method="post" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="deskripsi" value="<?php echo $p['deskripsi'] ?>" type="text" class="form-control">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Rating (1-5)</label>
                                                                    <input name="rate" value="<?php echo $p['rate'] ?>" type="number" class="form-control"  min="1" max="5" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Harga Sebelum Diskon</label>
                                                                    <input name="hargabefore" value="<?php echo $p['hargabefore'] ?>" type="number" class="form-control">
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input name="updateproduk" type="submit" class="btn btn-primary" value="Simpan">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal fade" id="delete<?=$idproduk;?>">
                                                    ...
                                                    <form method="post">
                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                        <h4 class="modal-title">Hapus Barang <?php echo $p['namaproduk']?></h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        </div>
                                                        
                                                        <!-- Modal body -->
                                                        <div class="modal-body">
                                                        Apakah Anda yakin ingin menghapus paket ini dari daftar wisata?
                                                    ...
                                                    if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
                                                        if($ukuran_file <= 5000000){ 
                                                          if(move_uploaded_file($tmp_file, $path)){ 
                                                            ...
                                                            $sql = mysqli_query($conn, "update produk set idkategori='$idkategori', namaproduk='$namaproduk', gambar='$pathdb', deskripsi='$deskripsi', rate='$rate', hargabefore='$hargabefore', hargaafter='$hargaafter' where idproduk='$idproduk'"); // Eksekusi/ Jalankan query dari variabel $query
